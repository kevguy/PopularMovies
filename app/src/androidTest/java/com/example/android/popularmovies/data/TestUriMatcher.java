...
//    private static final long TEST_LOCATION_ID = 10L;
    ...
    private static final String MOVIEID_QUERY = "12345";
    private static final boolean TEST_FAVORITE = true;

    // content://com.example.android.popularmovies/user
    private static final Uri TEST_USER_DIR = MovieContract.UserEntry.CONTENT_URI;
    private static final Uri TEST_USER_WITH_MOVIE_DIR = MovieContract.UserEntry.buildUserMovie(MOVIEID_QUERY);
    private static final Uri TEST_USER_WITH_MOVIE_AND_FAVORITE_DIR = MovieContract.UserEntry.buildUserMovieWithFavorite(MOVIEID_QUERY, TEST_FAVORITE);
...
/*    // content://com.example.android.sunshine.app/weather"
    ...
    public void testUriMatcher() {
        ...
        assertEquals("Error: The USER URI was matched incorrectly.",
                testMatcher.match(TEST_USER_DIR), MovieProvider.USER);
        assertEquals("Error: The USER WITH MOVIE URI was matched incorrectly.",
                testMatcher.match(TEST_USER_WITH_MOVIE_DIR), MovieProvider.USER_WITH_MOVIEID);
        assertEquals("Error: The USER WITH MOVIE AND FAVORITE URI was matched incorrectly.",
                testMatcher.match(TEST_USER_WITH_MOVIE_AND_FAVORITE_DIR), MovieProvider.USER_WITH_MOVIEID_AND_FAVORITE);
        assertEquals("Error: The MOVIE URI was matched incorrectly.",
                testMatcher.match(TEST_MOVIE_DIR), MovieProvider.MOVIEID);
    }

...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        // content://com.example.android.popularmovies/user/
        String type = mContext.getContentResolver().getType(UserEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.example.android.popularmovies/user
        ...
        // content://com.example.android.popularmovies/user/12345
        type = mContext.getContentResolver().getType(
                    UserEntry.buildUserMovie(testMovieID));
        // vnd.android.cursor.dir/com.example.android.popularmovies/user
        assertEquals("Error: the UserEntry CONTENT_URI with movieId should return UserEntry.CONTENT_TYPE",
                 UserEntry.CONTENT_ITEM_TYPE, type);

        boolean testFavorite = true;
        // content://com.example.android.popularmovies/user/12345/true
        type = mContext.getContentResolver().getType(
                UserEntry.buildUserMovieWithFavorite(testMovieID, testFavorite));
        // vnd.android.cursor.item/com.example.anddroid.popularmovies/user/true
        assertEquals("Error: the UserEntry CONTENT_URI with movieId and favorite should return UserEntry.CONTENT_ITEM_TYPE",
                UserEntry.CONTENT_ITEM_TYPE, type);

        // content://com.example.android.popularmovies/movieId/
        type = mContext.getContentResolver().getType(MovieEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.example.android.popularmovies/movieId
        assertEquals("Error: the MovieEntry CONTENT_URI should return LocationEntry.CONTENT_TYPE",
    ...
    public void testBasicUserQuery() {
        ...
        long locationRowId = TestUtilities.insertKevLaiMovieValues(mContext);

        // Fantastic. Now that we have a movie, add some user stuff!
        ContentValues userValues = TestUtilities.createUserValues(locationRowId);
        ...
        TestUtilities.validateCursor("testBasicUserQuery", userCursor, userValues);
    }
...
//    }
    ...
    public void testBasicMovieQueries() {
        ...
        // Make sure we get the correct cursor out of the database
        TestUtilities.validateCursor("testBasicMovieQueries, movieid query", movieCursor, testValues);
...
//    }
    ...
    public void testUpdateMovie() {
        ...
        ContentValues values = TestUtilities.createKevLaiMovieValues();
        ...
        updatedValues.put(MovieEntry.COLUMN_TITLE, "Kev Lai is a rock star!");
...
//    }
    ...
    public void testInsertReadProvider() {
        ...
        userValues.putAll(testValues);

        // Get the joined User and Movie data
        userCursor = mContext.getContentResolver().query(
                UserEntry.buildUserMovie(TestUtilities.TEST_MOVIEID),
                null, // leaving "columns" null just returns all the columns.
                null, // cols for "where" clause
                null, // values for "where" clause
                null  // sort order
...
//                UserEntry.buildWeatherLocationWithStartDate(
...
//                weatherCursor, weatherValues);
        ...
        // Get the joined User data for a specific favorite state
        userCursor = mContext.getContentResolver().query(
                UserEntry.buildUserMovieWithFavorite(TestUtilities.TEST_MOVIEID, TestUtilities.TEST_FAVORITE),
                null,
                null,
                null,
                null
        );
        TestUtilities.validateCursor("testInsertReadProvider.  Error validating joined User and Movie data for a favorite option.",
                userCursor, userValues);
    }

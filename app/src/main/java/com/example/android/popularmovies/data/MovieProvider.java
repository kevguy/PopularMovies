...
public class MovieProvider extends ContentProvider {
    ...
    static final int USER_WITH_MOVIEID = 101;
    static final int USER_WITH_MOVIEID_AND_FAVORITE = 102;
    static final int MOVIEID = 300;
...
//                    "." + WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING + " = ? ";
    ...
    //movie.movie_id = ? AND favorite = ?
    private static final String sMovieIDWithFavoriteSelection =
            MovieContract.MovieEntry.TABLE_NAME+
...
//                    WeatherContract.WeatherEntry.COLUMN_DATE + " = ? ";
    ...
    private Cursor getUserByMovieID(Uri uri, String[] projection, String sortOrder) {
        ...
        return sUserByMovieIDQueryBuilder.query(mOpenHelper.getReadableDatabase(),
                projection,
                selection,
                selectionArgs,
                null,
...
//    }
    ...
    private Cursor getUserByMovieIDAndFavorite(
...
/*    private Cursor getWeatherByLocationSettingAndDate(
    ...
    static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, MovieContract.PATH_USER, USER);
        matcher.addURI(authority, MovieContract.PATH_USER + "/*", USER_WITH_MOVIEID);
        matcher.addURI(authority, MovieContract.PATH_USER + "/*/*", USER_WITH_MOVIEID_AND_FAVORITE);
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case USER_WITH_MOVIEID_AND_FAVORITE:
                return MovieContract.UserEntry.CONTENT_ITEM_TYPE;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            case USER: {
                ...
                if (_id > 0)
                    returnUri = MovieContract.UserEntry.buildUserUri(_id);
                else
        ...
        switch (match) {
            case USER:
                rowsDeleted = db.delete(
                        MovieContract.UserEntry.TABLE_NAME, selection, selectionArgs);
                break;
...
/*    private void normalizeDate(ContentValues values) {
        ...
        if (values.containsKey(MovieContract.UserEntry.COLUMN_DATE)) {
            long dateValue = values.getAsLong(MovieContract.UserEntry.COLUMN_DATE);
            values.put(MovieContract.UserEntry.COLUMN_DATE, MovieContract.normalizeDate(dateValue));
        }
    }*/
    ...
    public int update(
        ...
        switch (match) {
            case USER:
                rowsUpdated = db.update(MovieContract.UserEntry.TABLE_NAME, values, selection,
                        selectionArgs);
                break;
            case MOVIEID:
